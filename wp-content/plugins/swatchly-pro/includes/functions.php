 ...
 * @return string|null
 */
function swatchly_pro_get_option( $option_name = '', $default = null, $override_for = null ) {
 ...
 * @return string|null
 */
function swatchly_pro_get_post_meta( $product_id, $taxonomy, $option_name = '', $default = '') {
    // product override
 ...
 * @return array
 */
function swatchly_pro_get_image_sizes() {
 ...
 * @return string
 */
function swatchly_pro_get_swatch_type( $taxonomy, $product_id = null ) {
    $swatch_type = 'select';
