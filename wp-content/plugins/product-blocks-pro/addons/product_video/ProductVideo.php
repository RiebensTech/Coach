...
class ProductVideo {
    ...
    function init_metabox_callback() {
        $title = '<div class="wopb-single-product-meta-box"><img src="' . WOPB_URL . 'assets/img/logo-sm.svg" /><span>'. __( 'Product Video', 'product-blocks-pro' ).'</span></div>';
        add_meta_box(
        ...
        <div class="wopb-video-meta-fields">
            <div class="wopb-video-type-tabs">
                <label class="wopb-video-type-tab<?php echo $data_value['type'] != 'media' ? ' wopb-active' : ''; ?>">
                    ...
                    <?php echo esc_html__( 'Youtube / Vimeo', 'product-blocks-pro' ); ?>
                </label>
                <label class="wopb-video-type-tab<?php echo $data_value['type'] == 'media' ? ' wopb-active' : ''; ?>">
                    <input name="wopb_video_type" value="media" type="radio">
                    <?php echo esc_html__( 'Media Library', 'product-blocks-pro' ); ?>
                </label>
            </div>
            <p class="form-field wopb_video_url_field ">
                <label for="wopb_video_url"><?php echo esc_html__( 'Video URL', 'product-blocks-pro' );?></label>
                ...
                <span class="wopb-video-note"><?php echo esc_html__( 'Note: Custom video frame size should be same as the featured image', 'product-blocks-pro' ); ?></span>
            </p>
            <p class="form-field wopb_video_image_field">
                <label for="wopb_video_image"><?php echo esc_html__( 'Gallery Image', 'product-blocks-pro' );?></label>
                <span class="wopb-input-media-group">
                ...
                <span class="wopb-video-note"><?php echo esc_html__( 'Note: Image size should be same as the featured image', 'product-blocks-pro' ); ?></span>
            </p>
            <p class="form-field">
                <label for="wopb_video_single_position">
                    <?php echo __( 'Position in Single Product Gallery', 'product-blocks-pro' ); ?>
                </label>
            ...
            <p class="form-field wopb_video_autoplay_field">
                <input type="checkbox" name="wopb_video_autoplay" value="yes" class="checkbox" <?php echo checked( $data_value['auto'], 'yes', false ); ?>>
                <label for="wopb_video_autoplay"><?php echo __( 'Video Autoplay', 'product-blocks-pro' ); ?></label>
            </p>
            <p class="form-field wopb_video_repeat_field<?php echo $type_depend_class; ?>">
                <input type="checkbox" name="wopb_video_repeat" value="yes" class="checkbox" <?php echo checked( $data_value['repeat'], 'yes', false ); ?>>
                <label for="wopb_video_repeat"><?php echo esc_html__( 'Video Repeat', 'product-blocks-pro' ); ?></label>
            </p>
            <p class="form-field  wopb_video_hover_field <?php echo  ($data_value['auto'] == "yes" || isset($_POST['wopb_video_autoplay']) ? ' wopb-d-none '.(isset($_POST['wopb_video_type']) ? $_POST['wopb_video_type'] : ' x ') :  $type_depend_class ); ?>">
                <input type="checkbox" name="wopb_video_hover" value="yes" class="checkbox" <?php echo checked( $data_value['hover'], 'yes', false ); ?>>
                <label for="wopb_video_hover"><?php echo esc_html__('Play On Hover', 'product-blocks-pro'); ?></label>
            </p>
        </div>
    <?php
    }
