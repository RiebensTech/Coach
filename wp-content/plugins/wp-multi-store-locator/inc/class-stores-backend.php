...
if (!class_exists('WPMSL_Stores_Backend')) {
    class WPMSL_Stores_Backend
    {
        ...
        public function register_stores_submenu_page()
        {
            ...
            add_submenu_page(
                'edit.php?post_type=store_locator',
                '<span class="dashicons dashicons-star-filled"></span> ' . esc_html__('Get Pro', 'store_locator'),
                '<span class="dashicons dashicons-star-filled"></span> ' . esc_html__('Get Pro', 'store_locator'),
                'manage_options',
                'https://wpmultistorelocator.com/pricing?utm_source=plugin&utm_medium=side_menu&utm_campaign=free_plugin&utm_id=free_plugin_01'
            );
        }
        ...
        public function store_locator_custom_dashboard_widgets()
        {
            ...
            wp_add_dashboard_widget(
                'store_locator_custom_dashboard_widget',
                esc_html__('Top Search for Stores', 'store_locator'),
        ...
        public function pro_banner_mapsettings_vertical(){
            ...
            echo '<a href="' . $pro_UTM_URL . '" target="_blank"><img src="' . $pro_banner_image_url . '" alt="Pro-Banner" style="width: 100%; padding-bottom: 1vw;"></a>';
        } 
        public function add_map_locator_meta()
        {
            ...
            if ( $post_type === 'maps' ) {
                add_action('submitpost_box', [$this, 'pro_banner_mapsettings_vertical']);
            }
        ...
        ?>
            ...
            <div class="inside store_locator_map_settings" <?php echo (isset($map_options['global']) &&  $map_options['global'] == 'yes') ? 'style="display:none;"' : ''; ?>>
                ...
                <hr>
                <p>
                    <label title="<?php echo esc_html__('You can customise the contetnt of the info window here by adding HTML if you need. Also you can use the below variables in the content', 'store_locator'); ?>" for="store_locator_map_infowindow"> <strong><?php echo esc_html__("Info Window Content", 'store_locator'); ?>: </strong>
                        <p class="store_locator_tip">placeholders: {image} {address} {city} {state} {country} {zipcode} {name} {phone} {email} {website} {working_hours}</p>
                    </label>
                ...
                <p>
                    <label title="<?php echo esc_html__('You can customize the look of the map by adding styles here', 'store_locator'); ?>" for="store_locator_map_style"><strong><?php echo esc_html__("Customised Map Style", 'store_locator'); ?>:</strong>
                        <p class="store_locator_tip"><?php esc_html_e('You can get some styles from', 'store_locator'); ?><a target="_blanck" href="https://snazzymaps.com"> <?php esc_html_e('Snazzy Maps', 'store_locator'); ?></a></p>
                    </label>
            ...
            <div class="store_locator_grid_settings" <?php echo (isset($grid_options['global']) &&  $grid_options['global'] == 'yes') ? 'style="display:none;"' : ''; ?>>
                ...
                <table class="wpml-table">
                    <tbody>
                        ...
                        <tr class="hide_if_fullscreen_map hide_if_regular_map">
                            <th>
                        ...
                        <tr class="hide_if_regular_map hide_if_fullscreen_map">
                            <th>
