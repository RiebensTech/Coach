<div class="store_locator_settings_div">
    <?php if ($_SERVER['REQUEST_METHOD'] == 'POST'): ?>
        <div class="updated below-h2">
            <p><?php esc_html_e("Settings updated.", 'store_locator'); ?></p>
        </div>
    <?php endif; ?>
...
if (!class_exists('WP_Multi_Store_Locator_Settings')) {
    class WP_Multi_Store_Locator_Settings
    {
        ...
        public function init_tabs($tabs = array())
        {
            ...
            $html .= '<a class="nav-tab getProTab" href="https://wpmultistorelocator.com/pricing?utm_source=plugin&utm_medium=side_menu&utm_campaign=free_plugin&utm_id=free_plugin_01" target="_blank"><span class="dashicons dashicons-star-filled"></span> Get Pro</a>';
            $html .= '</h2>';
            echo $html;
        }
        public function pro_banner_image_vertical()
        {
            $pro_banner_image_url = plugins_url('assets/img/pro_banner.png', dirname(__FILE__));
            $pro_UTM_URL = 'https://wpmultistorelocator.com/pricing?utm_source=plugin&utm_medium=side_banner&utm_campaign=free_plugin&utm_id=free_plugin_01';
            return '<a href="' . $pro_UTM_URL . '" target="_blank"><img src="' . $pro_banner_image_url . '" alt="Pro-Banner" style="width: 100%;"></a>';
        }
...
?>
            <div class="wrap">
                <div class="metabox-holder" style="display: flex;">
                    <div style="width: 75%;">
                        <form method="POST">
                            <div class="postbox">
                                ...
                                <h3 style="cursor: auto;" class="hndle"><span><?php esc_html_e("Google Maps Api", 'store_locator'); ?></span></h3>
                                    ...
                                    <table class="widefat" style="border: 0px;">
                                        ...
                                        <?php if (!empty($store_locator_API_KEY)): ?>
                                            <tbody>
                                                <tr>
                                                    <td colspan="2">
                                                        <h3><?php esc_html_e("Map Landing Address", 'store_locator'); ?></h3>
                                                    </td>
                                                </tr>
                                                <tr>
                                        ...
                                        <?php else: ?>
                                            <tr>
                                                <td colspan="2"><?php esc_html_e('To set map landing address please add API key first.', 'store_locator'); ?></td>
                                            </tr>
                                        <?php endif; ?>
                    ...
                    <div style="width: 25%;padding: 2px 15px;">
                        <?php echo $this->pro_banner_image_vertical() ?>
                    </div>
                </div>
            </div>
        <?php
                ...
                <div class="metabox-holder" style="display: flex;">
                    <div style="width: 75%;">
                        ...
                        <form method="POST">
                            <div class="postbox">
                                <div class="handlediv"><br></div>
                                <h3 style="cursor: auto;" class="hndle"><span><?php esc_html_e("Map Settings", 'store_locator'); ?></span></h3>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><input value="<?php echo $map_options['radius']; ?>" type="text" id="store_locator_map_radius" name="store_locator_map[radius]">
                                                    <div class="store_locator_tip">e.g: 5,10,[25],50,100,200,500</div>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td colspan="2"><b><?php esc_html_e('Map Styles', 'store_locator'); ?></b></td>
                                            </tr>
                                            <tr>
                                                <td colspan="2">
                                            ...
                                            <tr>
                                                <td colspan="2"><label title="<?php esc_html_e('You can customise the contetnt of the info window here by adding HTML if you need. Also you can use the below variables in the content', 'store_locator'); ?>" for="store_locator_map_infowindow"><b><?php esc_html_e("Info Window Content", 'store_locator'); ?></b>: </label>
                                                    <p class="store_locator_tip">placeholders: {image} {address} {city} {state} {country} {zipcode} {name} {phone} {website} {working_hours}</p>
                                                    <textarea name="store_locator_map[infowindow]" rows="10" cols="70" id="store_locator_map_infowindow" class="widefat"><?php echo $map_options['infowindow']; ?></textarea>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="2"><label title="<?php esc_html_e('You can customize the look of the map by adding styles here', 'store_locator'); ?>" for="store_locator_map_style"><b><?php esc_html_e("Customised Map Style", 'store_locator'); ?></b>: <p class="store_locator_tip"><?php esc_html_e('You can get some styles from', 'store_locator'); ?><a target="_blanck" href="https://snazzymaps.com"> <?php _e('Snazzy Maps', 'store_locator'); ?></a></p> </label>
                                                    <textarea name="store_locator_map[custom_style]" rows="10" cols="70" id="store_locator_map_style" class="widefat"><?php echo stripslashes($map_options['custom_style']); ?></textarea>
                                                </td>
                                            </tr>
                                            <tr class="submit">
                ...
                <div class="metabox-holder" style="display: flex;">
                    <div style="width: 75%;">
                        <form method="POST">
                            <div class="postbox">
                                <div class="handlediv"><br></div>
                                <h3 style="cursor: auto;" class="hndle"><span><?php esc_html_e("Placeholder Text", 'store_locator'); ?></span></h3>
                                <div class="inside store_locator_grid_settings">
                                    <table>
                                        <tbody>
                                            <tr>
                                                <th><?php esc_html_e('Get Location Text Button', 'store_locator'); ?></th>
                                            ...
                                            <tr>
                                                <th><?php esc_html_e('Search Button Text', 'store_locator'); ?></th>
                                            ...
                                            <tr>
                                                <th><?php esc_html_e('Get Direction Text', 'store_locator'); ?></th>
                                            ...
                                            <tr>
                                                <th><?php esc_html_e('Enter Location Text', 'store_locator'); ?></th>
                                            ...
                                            <tr>
                                                <th><?php esc_html_e('Select Category', 'store_locator'); ?></th>
                                            ...
                                            <tr>
                                                <th><?php esc_html_e('Select Tags', 'store_locator'); ?></th>
                                            ...
                                            <tr>
                                                <th><?php esc_html_e('Search Options Button Text', 'store_locator'); ?></th>
                                            ...
                                            <tr>
                                                <th><?php esc_html_e('Location not found text', 'store_locator'); ?></th>
                                            ...
                                            <tr>
                                                <th><?php esc_html_e('Store list text', 'store_locator'); ?></th>
                                            ...
                                            <tr>
                                                <th><?php esc_html_e('Visit Website text', 'store_locator'); ?></th>
                        ...
                        <form method="POST">
                            <div class="postbox">
                                ...
                                <h3 style="cursor: auto;" class="hndle">
                                    <span><?php esc_html_e("Grid Settings", 'store_locator'); ?></span>
                                </h3>
                                <div class="inside store_locator_grid_settings">
        ...
        public function single_page_settings()
        {
            ...
            if (isset($_POST['single-settings'])) {
                ...
                foreach ($_POST['store_locator_single'] as $key => $value) {
                    if (is_array($value)) {
                        foreach ($value as $sub_key => $sub_value) {
                            $_POST['store_locator_single'][$key][$sub_key] = sanitize_text_field($sub_value);
                        }
                    } else {
                        $_POST['store_locator_single'][$key] = sanitize_text_field($value);
                    }
                }
                ...
                <div class="metabox-holder" style="display: flex;">
                    <div style="width: 75%;">
                        ...
                        <form method="POST">
                            <div class="postbox">
                                <div class="handlediv"><br></div>
                                <h3 style="cursor: auto;" class="hndle"><span><?php esc_html_e("Single Page Settings", 'store_locator'); ?></span></h3>
                                <div class="inside store_locator_singel_page_settings">
                                    ...
                                    <table style="text-align: left;">
                                        ...
                                        <tr>
                                            <th>
                                                <label title="<?php esc_html_e('Enter Unique Slug Name', 'store_locator') ?>" for="store_locator_slug"><?php esc_html_e("Enter Unique Slug Name", 'store_locator'); ?></label>
                                            </th>
                                            <td>
                                                <input placeholder="store-locator" value="<?php echo isset($single_options['store_locator_slug']) ? esc_attr($single_options['store_locator_slug']) : ''; ?>" type="text" id="store_locator_slug" name="store_locator_single[store_locator_slug]">
                                            </td>
                                        </tr>
