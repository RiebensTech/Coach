    ...
    public function render_webtoffee_wishlist_button() {
        ...
        if(isset($wt_wishlist_button_style_settings_options['wt_button_type'])){
            ...
            if($wt_wishlist_button_style_settings_options['wt_button_type'] == 'text'){
                ...
                echo "<div class='single_product_div'> <a href='#' style ='display:inline-flex'> <img class='wishlist_text_icon_image " . esc_attr( $class ) . " wt-wishlist-button' data-act='add' data-action='" . esc_attr( $action ) . "' data-product_id='" . $product->get_id() . "' data-user_id='" . get_current_user_id() . "' style='margin-top: 4px !important; height:16px !important;' src='".esc_url( $text_icon_src )."'> <span class='" . esc_attr( $class ) . " wt-wishlist-button' data-act='add' data-action='" . esc_attr( $action ) . "' data-product_id='" . $product->get_id() . "' data-user_id='" . get_current_user_id() . "' >".esc_html__( $text_title )."</span></a> ".wp_kses( $element, $allowed_html )." </div>";

            }else if($wt_wishlist_button_style_settings_options['wt_button_type'] == 'icon'){

                echo "<div class='single_product_div'> <a href='#' > <i class='" . esc_attr( $class ) . " wt-wishlist-button' data-act='add' data-action='" . esc_attr( $action ) . "' data-product_id='" . $product->get_id() . "' data-user_id='" . get_current_user_id() . "' ><img style='width:auto; display:inline-flex; margin-bottom: 0px !important;'src='".esc_url( $text_icon_src )."'></i> </a> ".wp_kses_post( $element )." </div>";
                ...
                if($product_added == 1){
                    echo "<div class='single_product_div single_product_button_div' style ='padding-left: 0px;padding-bottom: 5px;'> <a href='#' style ='display:inline-flex'> <img class='wishlist_text_icon_image" . esc_attr( $class ) . " wt-wishlist-button' data-act='add' type-action='btn' data-action='" . esc_attr( $action ) . "' data-product_id='" . $product->get_id() . "' data-user_id='" . get_current_user_id() . "' style='margin-top: 4px !important; height:16px !important' src='".esc_url( $text_icon_src )."'> <span class='" . esc_attr( $class ) . " wt-wishlist-button' data-act='add' type-action='btn' data-action='" . esc_attr( $action ) . "' data-product_id='" . $product->get_id() . "' data-user_id='" . get_current_user_id() . "' >".esc_html__( $button_msg )."</span></a><button class='button " . esc_attr( $class ) . esc_attr( $button_class ). " wt-wishlist-button' style='display:none' data-act='add' data-action='add' data-product_id='" . $product->get_id() . "' data-user_id='" . get_current_user_id() . "' >".esc_html__( $button_msg_old )."</button> ".wp_kses_post( $element )." </div>";
                }else{
                    echo "<div class='single_product_div single_product_button_div' style ='padding-left: 0px;padding-bottom: 5px;'>  <a href='#' style='display:none'> <img class='wishlist_text_icon_image" . esc_attr( $class ) . " wt-wishlist-button' data-act='add' type-action='btn' data-action='remove' data-product_id='" . $product->get_id() . "' data-user_id='" . get_current_user_id() . "' style='margin-top: 4px !important; height:16px !important' src='".esc_url( $text_icon_src_for_btn )."'> <span class='" . esc_attr( $class ) . " wt-wishlist-button' data-act='add' type-action='btn' data-action='remove' data-product_id='" . $product->get_id() . "' data-user_id='" . get_current_user_id() . "' >".esc_html__( $button_msg_to_change )."</span></a><button class='button " . esc_attr( $class ) . esc_attr( $button_class ). " wt-wishlist-button' data-act='add' data-action='" . esc_attr( $action ) . "' data-product_id='" . $product->get_id() . "' data-user_id='" . get_current_user_id() . "' >".esc_html__( $button_msg )."</button>".wp_kses_post( $element )." </div>";
                }
