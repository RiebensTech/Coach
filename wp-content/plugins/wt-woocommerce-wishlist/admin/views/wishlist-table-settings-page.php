...
<div class="wt_mainform">
    <form action="options.php"  method="post">
        ...
        <h2 class="settings_title"><?php esc_html_e('Wishlist page settings', 'wt-woocommerce-wishlist'); ?></h2>

        <table class="wt-form-table">
            <tbody>

                <tr valign="top">
                    <th   scope="row"><?php esc_html_e('Wishlist page','wt-woocommerce-wishlist'); ?>
                    </th>
                    <td > 
                        ...
                        <input name="wt_wishlist_table_settings[wt_wishlist_page_old]" type="hidden"  id="wt_wishlist_table_settings[wt_wishlist_page_old]" value=<?php echo esc_attr( $selected_page ) ?>>
                        <span class="wt_form_help"><?php esc_html_e("Defaulted to 'My Wishlist' page. Select an alternative page from the dropdown to change it.",'wt-woocommerce-wishlist'); ?></span>  
                    </td>
                </tr>

                <tr valign="top">
                    <th scope="row" style="padding-bottom:7px;"><?php esc_html_e('Enable wishlist table contents','wt-woocommerce-wishlist'); ?></th>
                    <td style="padding-bottom:7px;"> 
                        ...
                        <label for="wt_wishlist_table_settings[wt_enable_product_variation_column]"><?php esc_html_e('Product variations(example: size, color)','wt-woocommerce-wishlist'); ?></label>
                    </td>
                </tr>
                <tr valign="top" >
                    ...
                    <td class="checkbox_options"> 
                        ...
                        <label for="wt_wishlist_table_settings[wt_enable_unit_price_column]"><?php esc_html_e('Unit price','wt-woocommerce-wishlist'); ?></label>
                    </td>
                </tr>
                ...
                <tr valign="top" >
                    ...
                    <td class="checkbox_options"> 
                        ...
                        <label for="wt_wishlist_table_settings[wt_enable_wishlisted_date_column]"><?php esc_html_e('Wishlisted date','wt-woocommerce-wishlist'); ?></label>
                    </td>
                </tr>
                <tr valign="top" >
                    <td scope="row" class="checkbox_options" ></td>
                    <td class="checkbox_options"> 
                        ...
                        <label for="wt_wishlist_table_settings[wt_enable_stock_status_column]"><?php esc_html_e('Stock status','wt-woocommerce-wishlist'); ?></label>
                    </td>
                </tr>
                <tr valign="top" >
                    <td scope="row" class="checkbox_options"></td>
                    <td class="checkbox_options"> 
                        ...
                        <label for="wt_wishlist_table_settings[wt_enable_add_to_cart_option_column]"><?php esc_html_e('Add to cart option','wt-woocommerce-wishlist'); ?></label>
                    </td>
                </tr>
                <tr valign="top" class="wt_enable_add_to_cart_option_element">
                    ...
                    <td class="checkbox_options" > 
                        ...
                        <div class="wt_sub_option_text_div"><label for="wt_wishlist_table_settings[wt_add_to_cart_text]"><?php esc_html_e('Add to cart text','wt-woocommerce-wishlist'); ?></label></div>
                        <div><input name="wt_wishlist_table_settings[wt_add_to_cart_text]" type="text" class="" id="wt_wishlist_table_settings[wt_add_to_cart_text]" placeholder="<?php esc_html_e('Add to cart','wt-woocommerce-wishlist'); ?>" value="<?php echo isset($wt_wishlist_table_settings_options['wt_add_to_cart_text']) ? esc_html( $wt_wishlist_table_settings_options['wt_add_to_cart_text'] ) : '';  ?>" class="regular-text"></div>
                        </div>
                    </td>
                </tr>

                <tr valign="top">
                    <th scope="row"><?php esc_html_e('Remove item from wishlist after adding to cart','wt-woocommerce-wishlist'); ?>
                    </th>
                    <td> 
                        <label class="switch" >
                ...
                <tr valign="top">
                    <th scope="row"><?php esc_html_e("Enable 'Add all to cart' button",'wt-woocommerce-wishlist'); ?>
                    </th>
                    <td> 
                        <label class="switch" >
                        ...
                        <span class="wt_form_help"><?php esc_html_e('\'Add all to cart\' button will move all wishlist products to cart.','wt-woocommerce-wishlist'); ?></span>  
                    </td>
                </tr>

                <tr valign="top">
                    <th scope="row"><?php esc_html_e('Redirect to cart','wt-woocommerce-wishlist'); ?>
                    </th>
                    <td> 
                        <label class="switch" >
                        ...
                        <span class="wt_form_help"><?php esc_html_e('Redirect users to cart page when they add product to cart from wishlist.','wt-woocommerce-wishlist'); ?></span>  
                    </td>
                </tr>
