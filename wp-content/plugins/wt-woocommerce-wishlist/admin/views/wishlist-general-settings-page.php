...
<div class="wt_mainform">
    <form action="options.php"  method="post">
        ...
        <h2 class="settings_title"><?php esc_html_e('General settings', 'wt-woocommerce-wishlist'); ?></h2>

        <table class="wt-form-table">
            <tbody>
               
                <tr valign="top">
                    <th scope="row"><?php esc_html_e('Show \'Add to wishlist\' only for logged in users','wt-woocommerce-wishlist'); ?>
                   </th>
                    <td> 
                        <label class="switch" >
                        ...
                        <span class="wt_form_help"><?php esc_html_e('Enabling will not allow guest users to move products to wishlist.','wt-woocommerce-wishlist'); ?></span>
                    </td>
                </tr>

                <tr valign="top">
                    <th scope="row"><?php esc_html_e("Show 'Add to wishlist' in pages",'wt-woocommerce-wishlist'); ?>
                    ...
                    <td> 
                        ...
                        <span class="wt_form_help"><?php esc_html_e("Show 'Add to wishlist' in chosen pages.",'wt-woocommerce-wishlist'); ?></span>
                    </td>
                </tr>
                
                <tr valign="top">
                    <th scope="row"><?php esc_html_e("Show 'Add to wishlist' for product categories",'wt-woocommerce-wishlist'); ?>
                    </th>
                    <?php 
                    ...
                    <td> 
                        ...
                        <span class="wt_form_help"><?php esc_html_e("Show 'Add to wishlist' in chosen product categories.",'wt-woocommerce-wishlist'); ?></span>
                    </td>
                </tr>

                <tr valign="top">
                    <th scope="row"><?php esc_html_e('Show \'My Wishlist\' in My account','wt-woocommerce-wishlist'); ?>
                    </th>
                    <td> 
                        <label class="switch" >
