...
define( 'UAFRICA_SHIPPING_API_TRACKING_V3', 'https://api.sandbox.bobgo.co.za/tracking?channel=DOMAIN&tracking_reference=NUMBER' );
// Endpoints for shipping methods and rates.
define( 'UAFRICA_SHIPPING_API_SHIPPING_METHODS_V3', 'https://api.sandbox.bobgo.co.za/rates-at-checkout/woocommerce' );
